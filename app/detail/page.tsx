    ...
    <div className="bg-[#181820]">
      ...
      <div className="relative left-1/2 top-0 w-full max-w-xl -translate-x-1/2 bg-white py-20">
        <div className="px-3.5">
          <div className="mx-3.5 mb-8 mt-4 rounded-xl bg-gradient-to-bl from-green-500 to-blue-400 px-3 py-12 text-center font-semibold text-white drop-shadow-xl sm:mx-auto sm:max-w-sm">
            <div
